...
/** Mode-aware accent so a restaurant-mode branch's login screen doesn't flash
 * violet before landing on the orange RestaurantTill — device.branch.mode
 * is already synced and known before this screen ever renders. */
function accentFor(mode: DeviceSession['branch']['mode']) {
