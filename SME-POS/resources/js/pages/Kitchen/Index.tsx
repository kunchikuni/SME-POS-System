        ...
        <AppLayout>
            ...
            <div className="flex items-start justify-between">
                ...
                <button
                    ...
                    className={`rounded-full p-2 ${soundOn ? "bg-green-100 text-green-700" : "bg-canvas text-muted"}`}
            ...
            <div className="mt-4 space-y-3">
                {visible.length === 0 ? (
                    <p className="py-16 text-center text-sm text-muted">No open tickets.</p>
                ) : (
                    visible.map((o) => {
                    ...
                    <span className="text-lg font-bold text-ink">
                      ...
                      {o.channel === "counter" ? "COUNTER" : o.table ?? "TABLE"}
                                    ...
                                    <span className="flex items-center gap-1 rounded-full bg-surface/70 px-2.5 py-1 text-xs font-medium text-muted">
