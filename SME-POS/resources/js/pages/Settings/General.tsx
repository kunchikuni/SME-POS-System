 ...
 *
 * Store mode used to live here (a tenant-wide toggle) — it's now a per-branch
 * setting managed on the Branches page instead, since two branches of the
 * same tenant can be genuinely different business types. See
 * Branches/Index.tsx and Branch::mode.
 */
